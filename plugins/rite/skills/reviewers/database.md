...
**CRITICAL** (data loss risk or major performance issue), **HIGH** (significant query performance or integrity issue), **MEDIUM** (suboptimal design or missing optimization), **LOW** (minor improvement).
