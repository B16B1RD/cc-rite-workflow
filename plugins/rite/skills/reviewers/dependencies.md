...
**CRITICAL** (security vulnerability or license violation), **HIGH** (unmaintained dependency or major incompatibility), **MEDIUM** (suboptimal dependency choice), **LOW** (minor improvement).
