...
| Technical Writer | `tech-writer.md` | `**/*.md` (excluding `commands/**`, `skills/**`, `agents/**`), `**/*.mdx` (same exclusions), `docs/**`, `documentation/**`, `**/README*`, `CHANGELOG*`, `CONTRIBUTING*`, `*.rst`, `*.adoc`, `i18n/**/*.{md,mdx}` (excluding `plugins/rite/i18n/**` — rite plugin's own translations are dogfooding artifacts) |
