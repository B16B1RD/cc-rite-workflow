...
# 8-10 as of this writing — 10 agents / Type Identifiers rows, 8 Available
# Reviewers rows; code-quality and acceptance are selected by rule, not pattern). An empty or undersized set
# almost always means
