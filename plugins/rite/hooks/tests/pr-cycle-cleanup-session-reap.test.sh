...
# ===========================================================================
# Why: OS-level live-cwd guard (regression of #1524). The cross-session
...
# ===========================================================================
# Why: claim-join (regression of #1524/#1544). The claim's liveness is
