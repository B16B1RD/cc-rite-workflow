...
#
# run-tests.sh and _test-helpers.sh source this file; tests that do not source
# _test-helpers.sh source it themselves. The name does not end in `.test.sh`, so
# run-tests.sh never runs it as a test.
