...
# cross-component coherence the half-migration finding (the governing rationale review) flagged.
...
echo "=== TC-9 (the governing rationale / T-03 / AC-3): flock 不在 PATH でロック経路が続行する ==="
