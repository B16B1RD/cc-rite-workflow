...
# target, the governing rationale). The helper applies the #2047-fixed index.md spec
...
# including the edge cases The observed review run's review loop surfaced (raw-pipe title,
# blank lines inside the section, old-format coexistence, duplicate rows).
#
# Coverage (IDs map to the governing rationale Section 6 Test Specification):
