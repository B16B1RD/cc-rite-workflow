...
domain: "patterns"
promote: rite-plugin
promoted_from: "wiki:/pages/patterns/markdown-channel-separation-for-terminal-sentinel.md"
...
- The observed review run cycle 6 review — markdown channel separation E-4 経験則 (`Wiki provenance: ../../raw/reviews/20260424T095915Z-pr-655-cycle6.md`)
- The observed review run cycle 4 review — markdown channel separation factual model 初提示 (`Wiki provenance: ../../raw/reviews/20260424T085837Z-pr-655.md`)
- The observed review run cycle 3 review — #652 Root Cause 散文モデル (`Wiki provenance: ../../raw/reviews/20260424T080338Z-pr-655.md`)
- The observed review run cycle 3 fix — inline HTML sentinel 適用実装 (`Wiki provenance: ../../raw/fixes/20260424T081225Z-pr-655.md`)
- The observed review run cycle 5 fix — factual correction と anti-pattern doc 整合 (`Wiki provenance: ../../raw/fixes/20260424T090428Z-pr-655.md`)
