...
domain: "patterns"
promote: rite-plugin
promoted_from: "wiki:/pages/patterns/placeholder-residue-gate-bash-fail-fast.md"
...
### 新設 helper にも gate を置く — sibling との対称性が判断基準（The observed review run cycle 3）
...
- The observed review run review results (cycle 1) (`Wiki provenance: ../../raw/reviews/20260418T122454Z-pr-579.md`)
- The observed review run fix results (cycle 1) (`Wiki provenance: ../../raw/fixes/20260418T122707Z-pr-579.md`)
- The observed review run review results (cycle 3) (`Wiki provenance: ../../raw/reviews/20260804T145133Z-pr-2111.md`)
