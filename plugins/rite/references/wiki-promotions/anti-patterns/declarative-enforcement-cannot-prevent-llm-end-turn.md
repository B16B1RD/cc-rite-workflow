...
```bash
JSONL=~/.claude/projects/<encoded-project-path>/<session-id>.jsonl
...
- The observed review run review results (cycle 10, rename の literal/semantic 分離指摘) (`Wiki provenance: ../../raw/reviews/20260528T025244Z-pr-1166.md`)
- The observed review run review results (cycle 21, converged — vocabulary 撤廃で収束) (`Wiki provenance: ../../raw/reviews/20260528T084055Z-pr-1166.md`)
