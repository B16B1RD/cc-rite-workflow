...
- `/rite:pr-review` ステップ 6.1.d (非実測指摘の PR コメント記録 — 本文不備 / gh / IO 失敗のみ非ブロッキング。placeholder residue 5 種 + `content_file_missing` + `unknown_option` の 7 種 は caller 契約違反として `exit 1`)
