...
domain: "heuristics"
description: "「規則 A が記録を命じているのに受け皿 B は optional」という矛盾は、B の緩和条件を削れば消えるが、同時に義務が A 以外の全ケースへ波及する。受け皿の実体がなければ、この波及は「誰も検出できない義務違反」を常態化させる。A 側の適用範囲を元の要求どおりの 1 ケースへ絞るほうが影響範囲が小さく、規則も短くなる。"
