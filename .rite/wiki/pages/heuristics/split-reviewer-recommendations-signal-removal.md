...
domain: "heuristics"
description: "レビュアーの推奨が収束せず、どの案も誤発火と見逃しのどちらかを増やす形にしかならないとき、問題は個々の案ではなく機構が測っている量そのものにある。追加パッチではなく撤去を既定選択に切り替える signal として使える。PR #2074 では cycle 1-3 で「fix が次 cycle の欠陥になる」が 3 巡続き、cycle 3 で削除に舵を切ってから収束が始まって cycle 4 で HIGH/CRITICAL がゼロになった。"
