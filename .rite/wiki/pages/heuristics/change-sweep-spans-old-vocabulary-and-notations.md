...
sources:
  - type: "reviews"
    resource: "raw/reviews/20260729T010436Z-pr-2044.md"
  - type: "reviews"
    resource: "raw/reviews/20260729T012311Z-pr-2044.md"
  - type: "reviews"
    resource: "raw/reviews/20260729T091817Z-pr-2044.md"
  - type: "reviews"
    resource: "raw/reviews/20260729T094749Z-pr-2044.md"
  - type: "fixes"
    resource: "raw/fixes/20260729T010744Z-pr-2044.md"
  - type: "fixes"
    resource: "raw/fixes/20260729T012520Z-pr-2044.md"
  - type: "fixes"
    resource: "raw/fixes/20260729T092343Z-pr-2044.md"
  - type: "fixes"
...
掃き出しの結果を守るために anti-pattern pin（旧語彙の再導入検出）を置いたあと、**誤発火を防ぐつもりで pattern に文脈語を足すと、実際に除去した表記形を取りこぼす**。ある PR の cycle 5 では禁止語と文脈語の間に markdown 強調記号が挟まる形が抜け、5 名のレビュアーが「実証済みの検出力を未観測の誤発火リスクと交換している」と指摘した。
...
canonical snippet / 共有 reference が「新規箇所を追加したら usage site として登録すること」と自ら指示している場合、**その指示は自分の PR にも掛かる**。同 PR の cycle 5 では save helper へ必須キーを 2 つ足しながら canonical 節へ登録しておらず、snippet に忠実な JSON が save 段で拒否される乖離を作っていた。
