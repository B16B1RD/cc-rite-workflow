...
- [`rejected(scope-creep)` の empirical revert test で CRITICAL 認定](../../raw/reviews/20260427T121800Z-pr-688.md)
- [cross-session takeover guard pattern + empirical 検証 gate 規範化](../../raw/fixes/20260427T122511Z-pr-688.md)
