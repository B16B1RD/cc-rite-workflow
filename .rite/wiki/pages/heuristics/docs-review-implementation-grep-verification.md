...
domain: "heuristics"
description: "Documentation の prose が言及する実装側 (commands/, scripts/, templates/, .ja./.md ペア) の現状 (file 存在・key live 状態・sentinel emit 経路・heading slug) を grep / `ls` / `git show` で機械的に verify する step が review protocol に欠落すると、CHANGELOG / SPEC / CONFIGURATION / migration-guide の記述が実装の現状と乖離したまま merge される。"
promote: rite-plugin
reference: "plugins/rite/references/wiki-promotions/heuristics/docs-review-implementation-grep-verification.md"
created: "2026-05-26T00:00:00Z"
sources:
  - type: "reviews"
    resource: "raw/reviews/20260713T082548Z-pr-1849.md"
  - type: "fixes"
    resource: "raw/fixes/20260713T081301Z-pr-1849.md"
  - type: "reviews"
    resource: "raw/reviews/20260707T051719Z-pr-1779.md"
  - type: "reviews"
    resource: "raw/reviews/20260706T220114Z-pr-1773-cycle3.md"
  - type: "fixes"
    resource: "raw/fixes/20260706T220317Z-pr-1773-cycle3.md"
  - type: "reviews"
    resource: "raw/reviews/20260706T210924Z-pr-1772.md"
  - type: "reviews"
    resource: "raw/reviews/20260525T070727Z-pr-1139.md"
  - type: "reviews"
    resource: "raw/reviews/20260525T081823Z-pr-1139.md"
  - type: "fixes"
    resource: "raw/fixes/20260525T104719Z-pr-1139.md"
  - type: "fixes"
    resource: "raw/fixes/20260525T124932Z-pr-1139.md"
  - type: "fixes"
    resource: "raw/fixes/20260525T141022Z-pr-1139.md"
  - type: "reviews"
    resource: "raw/reviews/20260602T082558Z-pr-1248.md"
  - type: "reviews"
    resource: "raw/reviews/20260603T162350Z-pr-1261.md"
  - type: "reviews"
...
7. **同 file 内の関連 prose grep**: fix 適用時に同 file 内の関連 prose を `grep` 検索し self-contradiction を防ぐ (cycle 7→8 で CONFIGURATION.md L548 を修正後の記述に書き直したが他 5 箇所が live モデル残置した self-contradiction を一括補修した教訓)。
...
- [リリース CHANGELOG の実装主張、日英 PR 番号列、前タグからのコミット網羅性を機械照合し 0 findings で収束](../../raw/reviews/20260812T055512Z-pr-2265.md)
- [-2 (trap 被覆設計ヘッダコメントの機構誤認を 2 reviewer 独立検出、cross-validation boost、cycle 2 で FIXED 収束)](../../raw/reviews/20260713T082548Z-pr-1849.md)
- [経路ごとの書き分け修正で 1 cycle 解消、コメントのみ修正でも影響スキャン省略しない教訓](../../raw/fixes/20260713T081301Z-pr-1849.md)
- [Doc-Heavy Implementation Coverage 検証で削除対象一覧ドキュメントのファサード化を検出](../../raw/reviews/20260706T220114Z-pr-1773-cycle3.md)
- [accept 決着: 後方互換性を理由に意図的現状維持、fingerprint 永続化](../../raw/fixes/20260706T220317Z-pr-1773-cycle3.md)
- [調査文書の定量的棚卸し全数値をgrep再実行で検証、tech-writer/code-quality両者独立全数一致、0 findings 1cycle mergeable](../../raw/reviews/20260706T210924Z-pr-1772.md)
- [anchor link typo / phantom sentinel / Asymmetric Fix Transcription on wave](../../raw/reviews/20260525T070727Z-pr-1139.md)
- [CHANGELOG `remain on disk` factual error / project.type CHANGELOG vs CONFIGURATION drift](../../raw/reviews/20260525T081823Z-pr-1139.md)
- [Verification Cross-Reference Gap 確立: review.md Phase 7 live を 5 cycle 経て初検出](../../raw/fixes/20260525T104719Z-pr-1139.md)
- [Implementation-Grep Verification Gap: fix 履歴の遡及 grep 必須化](../../raw/fixes/20260525T124932Z-pr-1139.md)
- [SPEC Multi-Section Same-Topic Drift: SPEC 全文 1 度通読の必要性](../../raw/fixes/20260525T141022Z-pr-1139.md)
- [prose 散文括弧書きの正確性を helper 出力語彙と cross-check、0 findings の successful application](../../raw/reviews/20260602T082558Z-pr-1248.md)
- [Doc-Heavy mode 5 カテゴリ検証で全実装主張を grep verify + pre-existing SPEC.ja.md i18n drift を revert-test で follow-up 化、0 findings の successful application](../../raw/reviews/20260603T162350Z-pr-1261.md)
