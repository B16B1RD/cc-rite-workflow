...
起点事例の cycle 2 で 3 reviewer が独立に CRITICAL として検出した欠陥。「非実測の指摘は blocking から降格するが破棄はしない」という MUST を書きながら、その記録先を統合レポートの section 1 本に置いたため、既定構成では記録が**どこにも残らなかった**。
