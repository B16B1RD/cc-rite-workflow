...
設計判断をコメントに残すとき「A を却下して B を採用した」と書く。このとき **却下理由が B にも成立する** なら、その理由は選択の根拠になっていない。にもかかわらずコメントに残ると、読者に「B はその問題を持たない」という **逆の安心** を与え、将来その問題が発現したときの調査を誤誘導する。PR #2013 cycle 2 で 3 レビュアーが独立に検出した。
