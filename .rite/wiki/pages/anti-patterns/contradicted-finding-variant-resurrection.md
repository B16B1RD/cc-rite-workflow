...
description: "reviewer agent が fact-check phase で CONTRADICTED 除外された主張 (例: 「ツールが存在しない」「概念が不在」) を、後続 cycle で **異なる variant に rephrase して再提起** する failure mode。"
promote: rite-plugin
...
- [code-quality F-X1 TaskCreate 不在主張、CONTRADICTED](../../raw/reviews/20260527T163952Z-pr-1164.md)
- [prompt-engineer F-X2 TaskCreate=Team variant 再提起、CONTRADICTED](../../raw/reviews/20260527T165719Z-pr-1164.md)
- [再提起なし、orchestrator prompt 注入 effective](../../raw/reviews/20260527T170947Z-pr-1164.md)
- [討論決着論点への拡張: 「解決済み論点を新 evidence なしに蒸し返さない」prompt 明示で source ガード論点の再燃なし、reviewer は修正検証に徹する役割転換が成立](../../raw/reviews/20260605T182035Z-pr-1281-cycle2.md)
