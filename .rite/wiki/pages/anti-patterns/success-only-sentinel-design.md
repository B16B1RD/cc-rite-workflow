...
description: "sub-skill 切出し時に success path 用 HTML sentinel (`<!-- [skill:phase:completed] -->`) のみを定義し、abort path / error path 用 sentinel を未定義のまま残す anti-pattern。"
promote: rite-plugin
...
- [10 findings, 1 cycle](../../raw/fixes/20260514T045140Z-pr-951.md)
