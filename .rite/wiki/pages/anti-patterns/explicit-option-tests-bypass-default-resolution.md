...
ある PR で同じ欠陥が **cycle 1 と cycle 5 の 2 回**、別々のオプションについて検出された。
...
0. **「本番が実際に使う唯一の引数形」を通す arm を必ず 1 本置く**（その 3 度目での定式化）。これは下記 1〜4 の要約であり、他をすべて忘れてもこれだけは残す
