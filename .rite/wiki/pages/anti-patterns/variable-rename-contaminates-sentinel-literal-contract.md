...
description: "bash 変数 rename refactor の際、変数名の見た目と同形だが downstream parser (cross-file aggregation) が grep 対象としている sentinel emit の literal token (`reason=...` / `details=...`) を、変数名の延長として一緒に書き換えてしまう anti-pattern。"
promote: rite-plugin
...
- [レビュー結果](../../raw/reviews/20260518T001536Z-pr-1034.md)
- [レビュー結果](../../raw/reviews/20260518T002525Z-pr-1034.md)
- [fix 結果](../../raw/fixes/20260518T001912Z-pr-1034.md)
