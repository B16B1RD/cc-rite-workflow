...
| Non-measured findings still remaining at merge (full text) | one follow-up Issue (none if zero, or if re-verification against the merged HEAD resolves every finding; public on a public repository) |
