...
詳細な改修計画は `/home/akiyoshi/.claude/plans/staged-beaming-flask.md` (plan file) を参照。
...
1. **原則ドキュメント層** (Layer 1)
   ...
   - `skills/reviewers/security.md`, `database.md`, `devops-reviewer.md`, `dependencies.md` — Hypothetical 例外宣言
...
review.md Phase 5 (Critic Pipeline)
  ├─ 5.1 Dedup
  ├─ 5.2 Fact-Check Phase (拡張)
  │    ├─ 5.2.1 External Claim Verification (既存)
  │    └─ 5.2.2 Internal Likelihood Claim Verification (新規)
  │         └─ Grep で call site 検証 → CONTRADICTED なら除外
  ├─ 5.3 Spec Consistency
  └─ 5.4 Assessment
...
| PR | 層 | 主要ファイル |
|---|---|---|
| PR #1 | 原則ドキュメント | `references/severity-levels.md`, `agents/_reviewer-base.md`, `skills/reviewers/SKILL.md`, `error-handling.md`, `code-quality.md`, `security.md`, `database.md`, `devops-reviewer.md`, `dependencies.md` |
...
- Plan file: `/home/akiyoshi/.claude/plans/staged-beaming-flask.md` (full design + 4 PR rollout + verification plan + risk mitigation)
